(globalThis["webpackChunkultimate_crypto_widget"] = globalThis["webpackChunkultimate_crypto_widget"] || []).push([["vendors"],{

/***/ "./react/helper/helper.ts":
/*!********************************!*\
  !*** ./react/helper/helper.ts ***!
  \********************************/
...
/* harmony export */   generateLabelArrayFromChartData: () => (/* binding */ generateLabelArrayFromChartData),
...
/* harmony export */   roundToSignificantFigures: () => (/* binding */ roundToSignificantFigures),
/* harmony export */   searchCoin: () => (/* binding */ searchCoin)
/* harmony export */ });
function abbreviateNumber(num) {
  var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var useCommas = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var abbreviations = [{
    value: 1e12,
    symbol: 'T'
  }, {
  ...
  for (var _i = 0, _abbreviations = abbreviations; _i < _abbreviations.length; _i++) {
    var _abbreviations$_i = _abbreviations[_i],
      value = _abbreviations$_i.value,
      symbol = _abbreviations$_i.symbol;
    if (num >= value) {
...
function roundToSignificantFigures(num, significantFigures) {
...
function generateLabelArrayFromChartData(chartData) {
  var labels = [];
  chartData.forEach(function (data) {
    var _data$data;
    if ((data === null || data === void 0 || (_data$data = data.data) === null || _data$data === void 0 ? void 0 : _data$data.length) > labels.length) {
      labels = data.data.map(function (_, i) {
        return "".concat(data.label || '', " ").concat(i);
      });
    }
  });
  return labels;
...
function levenshteinDistance(str1, str2) {
  ...
  var dp = Array.from(Array(len1 + 1), function () {
...
function searchCoin(needle, coins) {
  var minLevenshteinDistance = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
  var value = needle.toLowerCase();
  // if empty then show all coins
  if (value.length === 0) {
    return coins;
  }
  var filtered = coins.filter(function (coin) {
    var nameDistance = levenshteinDistance(coin.name.toLowerCase(), value.toLowerCase());
    var symbolDistance = levenshteinDistance(coin.symbol.toLowerCase(), value.toLowerCase());
  ...
  filtered.sort(function (a, b) {
    var nameDistanceA = levenshteinDistance(a.name.toLowerCase(), value);
    var nameDistanceB = levenshteinDistance(b.name.toLowerCase(), value);
    var symbolDistanceA = levenshteinDistance(a.symbol.toLowerCase(), value);
    var symbolDistanceB = levenshteinDistance(b.symbol.toLowerCase(), value);
    return nameDistanceA + symbolDistanceA - (nameDistanceB + symbolDistanceB);
  });
  return filtered;
}
;
...
/***/ "./node_modules/iconsax-react/dist/esm/ArrowDown.js":
/*!**********************************************************!*\
  !*** ./node_modules/iconsax-react/dist/esm/ArrowDown.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _rollupPluginBabelHelpers_3bc641ae_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_rollupPluginBabelHelpers-3bc641ae.js */ "./node_modules/iconsax-react/dist/esm/_rollupPluginBabelHelpers-3bc641ae.js");
...
var chooseVariant = function chooseVariant(variant, color) {
  switch (variant) {
    case 'Bold':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Bold, {
        color: color
      });

    case 'Broken':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Broken, {
        color: color
      });

    case 'Bulk':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Bulk, {
        color: color
      });

    case 'Linear':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Linear, {
        color: color
      });

    case 'Outline':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Outline, {
        color: color
      });

    case 'TwoTone':
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TwoTone, {
        color: color
      });
...
var ArrowDown = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (_ref7, ref) {
  var variant = _ref7.variant,
      color = _ref7.color,
      size = _ref7.size,
      rest = (0,_rollupPluginBabelHelpers_3bc641ae_js__WEBPACK_IMPORTED_MODULE_1__._)(_ref7, _excluded);

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", (0,_rollupPluginBabelHelpers_3bc641ae_js__WEBPACK_IMPORTED_MODULE_1__.a)({}, rest, {
...
ArrowDown.propTypes = {
  variant: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(['Linear', 'Bold', 'Broken', 'Bulk', 'Outline', 'TwoTone']),
...
/***/ "./node_modules/iconsax-react/dist/esm/ArrowUp.js":
/*!********************************************************!*\
  !*** ./node_modules/iconsax-react/dist/esm/ArrowUp.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ArrowUp = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (_ref7, ref) {
  var variant = _ref7.variant,
      color = _ref7.color,
      size = _ref7.size,
      rest = (0,_rollupPluginBabelHelpers_3bc641ae_js__WEBPACK_IMPORTED_MODULE_1__._)(_ref7, _excluded);
...
/***/ "./node_modules/iconsax-react/dist/esm/_rollupPluginBabelHelpers-3bc641ae.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/iconsax-react/dist/esm/_rollupPluginBabelHelpers-3bc641ae.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
